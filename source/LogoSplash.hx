...
class LogoSplash extends FlxState
{
    ...
    override public function create()
    {
        ...
        Logo = new FlxSprite().loadGraphic(AssetPaths.logo__png);
        Logo.screenCenter(X);
        Logo.y = -300;
        ...
        otherLogo = new FlxSprite().loadGraphic(AssetPaths.firekoopa__png);
    ...
    function doThing()
    {
        ...
        var penis = new FlxTimer().start(5, function(tmr:FlxTimer){
            ...
            FlxTween.tween(white, {alpha: 1}, 0.3, {onComplete: function(twn:FlxTween){
                ...
                FlxTween.tween(white, {alpha: 0}, 1, {onComplete: function(twn:FlxTween){
                    remove(white);
                }});
            }});
        });
        ...
        var dildo = new FlxTimer().start(9, function(tmr:FlxTimer){
            ...
            FlxTween.tween(black, {alpha: 1}, 4, {onComplete: function(twn:FlxTween){
