...
class HXCPP_CLASS_ATTRIBUTES AssetPaths_obj : public ::hx::Object
{
	...
	public:
		...
		static ::String ballman__png;
		static ::String banger_logo__png;
		static ::String Gamejolt__png;
		static ::String Locked__png;
		static ::String menubg__png;
		static ::String Options__png;
		static ::String Practice__png;
		static ::String Story__png;
		static ::String tophy__png;
		static ::String Versus__png;
		static ::String multiplayer__png;
		static ::String singleplayer__png;
		static ::String menu_theme__ogg;
