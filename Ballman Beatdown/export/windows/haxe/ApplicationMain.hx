...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Ballman Beatdown", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Ballman Beatdown", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "7";
		app.meta["company"] = "FireKoopa";
		app.meta["file"] = "Ballman Beatdown";
		app.meta["name"] = "Ballman Beatdown";
