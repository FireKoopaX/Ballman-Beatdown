...
HX_DEFINE_STACK_FRAME(_hx_pos_e5abf8620039da0e_13_new,"DiscordClient","new",0xa1a2b969,"DiscordClient.new","Discord.hx",13,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_35_shutdown,"DiscordClient","shutdown",0x0f46b2ed,"DiscordClient.shutdown","Discord.hx",35,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_40_onReady,"DiscordClient","onReady",0x690ae04d,"DiscordClient.onReady","Discord.hx",40,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_50_onError,"DiscordClient","onError",0xf57a0bb2,"DiscordClient.onError","Discord.hx",50,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_55_onDisconnected,"DiscordClient","onDisconnected",0xa84d7d11,"DiscordClient.onDisconnected","Discord.hx",55,0xa6c9e0b2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_59_initialize,"DiscordClient","initialize",0x1dd16b67,"DiscordClient.initialize","Discord.hx",59,0xa6c9e0b2)
HX_LOCAL_STACK_FRAME(_hx_pos_e5abf8620039da0e_70_changePresence,"DiscordClient","changePresence",0xb0052162,"DiscordClient.changePresence","Discord.hx",70,0xa6c9e0b2)
...
void DiscordClient_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_13_new)
HXLINE(  14)		::haxe::Log_obj::trace(HX_("Discord Client starting...",0d,5b,39,a8),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),14,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
HXLINE(  15)		::discord_rpc::DiscordRpc_obj::start( ::Dynamic(::hx::Anon_obj::Create(4)
            			...
            			->setFixed(2,HX_("clientID",e6,72,8f,15),HX_("1178373679948779530",2c,26,34,74))
            			->setFixed(3,HX_("onReady",c4,3e,f8,7c),::DiscordClient_obj::onReady_dyn())));
HXLINE(  21)		::haxe::Log_obj::trace(HX_("Discord Client started.",8e,09,8e,36),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),21,HX_("DiscordClient",f7,d0,c5,2b),HX_("new",60,d0,53,00)));
HXLINE(  23)		while(true){
HXLINE(  25)			::discord_rpc::DiscordRpc_obj::process();
HXLINE(  26)			::Sys_obj::sleep(( (Float)(2) ));
            		}
            	}
...
void DiscordClient_obj::shutdown(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_35_shutdown)
HXDLIN(  35)		::discord_rpc::DiscordRpc_obj::shutdown();
            	}
...
void DiscordClient_obj::onReady(){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_40_onReady)
HXDLIN(  40)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("state",11,76,0b,84),null())
            			->setFixed(1,HX_("details",c2,dc,56,ab),HX_("In the Menus",0a,c1,ad,c6))
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),HX_("main",39,38,56,48))
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("Ballman Beatdown",dd,bb,8b,29))));
            	}
...
void DiscordClient_obj::onError(int _code,::String _message){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_50_onError)
HXDLIN(  50)		::haxe::Log_obj::trace((((HX_("Error! ",87,92,5b,b7) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),50,HX_("DiscordClient",f7,d0,c5,2b),HX_("onError",29,6a,67,09)));
            	}
...
void DiscordClient_obj::onDisconnected(int _code,::String _message){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_55_onDisconnected)
HXDLIN(  55)		::haxe::Log_obj::trace((((HX_("Disconnected! ",7a,e1,87,53) + _code) + HX_(" : ",c6,7a,18,00)) + _message),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),55,HX_("DiscordClient",f7,d0,c5,2b),HX_("onDisconnected",7a,eb,5a,b8)));
            	}
...
void DiscordClient_obj::initialize(){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_e5abf8620039da0e_62_initialize)
HXLINE(  62)			 ::DiscordClient_obj::__alloc( HX_CTX );
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_59_initialize)
HXLINE(  60)		 ::sys::thread::_Thread::HaxeThread DiscordDaemon = ::sys::thread::_Thread::HaxeThread_obj::create( ::Dynamic(new _hx_Closure_0()),false);
HXLINE(  64)		::haxe::Log_obj::trace(HX_("Discord Client initialized",f3,a9,32,06),::hx::SourceInfo(HX_("source/Discord.hx",a6,a8,2e,33),64,HX_("DiscordClient",f7,d0,c5,2b),HX_("initialize",50,31,bb,ec)));
HXLINE(  65)		::DiscordClient_obj::isInitialized = true;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(DiscordClient_obj,initialize,(void))

void DiscordClient_obj::changePresence(::String details,::String state,::String largeImageKey){
            	HX_STACKFRAME(&_hx_pos_e5abf8620039da0e_70_changePresence)
HXDLIN(  70)		::discord_rpc::DiscordRpc_obj::presence( ::Dynamic(::hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("state",11,76,0b,84),state)
            			->setFixed(1,HX_("details",c2,dc,56,ab),details)
            			->setFixed(2,HX_("largeImageKey",df,8f,e3,ae),largeImageKey)
            			->setFixed(3,HX_("largeImageText",6d,3e,2d,5e),HX_("Ballman Beatdown",dd,bb,8b,29))));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC3(DiscordClient_obj,changePresence,(void))
